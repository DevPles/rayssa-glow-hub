          ...
          <div className="grid lg:grid-cols-[1fr_auto] gap-6 items-center">
            ...
            <div className="hidden lg:flex justify-center">
              <div className="relative">
                <div className="w-48 h-56 rounded-2xl overflow-hidden border-3 border-accent/30 shadow-xl shadow-accent/20 relative">
                  <img src={cfg?.photoUrl || rayssaPortrait} alt={cfg?.expertName || "Especialista"} className="w-full h-full object-cover" />
                  <Badge className="absolute top-2 left-2 bg-accent/90 text-accent-foreground text-[9px] font-heading border-0 px-2 py-0.5">Especialista</Badge>
                  <div className="absolute bottom-0 inset-x-0 bg-black/20 backdrop-blur-md p-2">
                    ...
                    <p className="text-white/80 text-[10px]">{cfg?.expertSubtitle || "Enfermeira Obstetra"}</p>
                  </div>
                </div>
              </div>
            </div>
