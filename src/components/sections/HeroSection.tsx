      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid gap-12 items-center">
          ...
          <div className="relative">
            <img src={logo} alt="LeMater" className="absolute -top-[36rem] -left-10 w-[32rem] md:w-[40rem] lg:w-[48rem] object-contain opacity-60 pointer-events-none select-none drop-shadow-2xl" />
