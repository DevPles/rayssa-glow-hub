...
export const VACCINES_BRAZIL: VaccineInfo[] = [
  ...
  // CONTRAINDICADAS
  { name: "Febre Amarela", doses: ["Dose Única", "Reforço"], category: "contraindicada", trimester: "CONTRAINDICADA", gestationalAlert: "CONTRAINDICADA na gestação, exceto em surtos com alto risco epidemiológico.", manufacturers: ["Fiocruz/Bio-Manguinhos", "Sanofi (Stamaril)"], commonReactions: ["Febre", "Cefaleia", "Mialgia"] },
  { name: "Tríplice Viral (SCR)", doses: ["1ª Dose", "2ª Dose"], category: "contraindicada", trimester: "CONTRAINDICADA", gestationalAlert: "CONTRAINDICADA na gestação. Vacinar no puerpério imediato se suscetível.", manufacturers: ["Fiocruz/Bio-Manguinhos", "Merck (M-M-R II)", "GSK (Priorix)"], commonReactions: ["Febre", "Exantema", "Artralgia"] },
  { name: "Varicela", doses: ["1ª Dose", "2ª Dose"], category: "contraindicada", trimester: "CONTRAINDICADA", gestationalAlert: "CONTRAINDICADA na gestação. Vacinar no puerpério se suscetível.", manufacturers: ["Merck (Varivax)", "GSK (Varilrix)"], commonReactions: ["Dor local", "Febre baixa", "Exantema leve"] },
